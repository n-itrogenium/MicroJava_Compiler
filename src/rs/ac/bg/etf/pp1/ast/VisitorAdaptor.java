...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(DesFactor DesFactor) { visit(); }
    ...
    public void visit(NotFirstTerm NotFirstTerm) { visit(); }
    public void visit(PositiveTerm PositiveTerm) { visit(); }
    public void visit(NegativeTerm NegativeTerm) { visit(); }
    public void visit(LessRelOp LessRelOp) { visit(); }
    public void visit(LessEqRelOp LessEqRelOp) { visit(); }
    public void visit(GreaterRelOp GreaterRelOp) { visit(); }
    public void visit(GreaterEqRelOp GreaterEqRelOp) { visit(); }
    public void visit(NotEqualRelOp NotEqualRelOp) { visit(); }
    public void visit(EqualRelOp EqualRelOp) { visit(); }
    ...
    public void visit(ExpressionSingle ExpressionSingle) { visit(); }
    ...
    public void visit(DesSingle DesSingle) { visit(); }
    public void visit(DesList DesList) { visit(); }
    public void visit(CallExpr CallExpr) { visit(); }
    public void visit(DecExpr DecExpr) { visit(); }
    public void visit(IncExpr IncExpr) { visit(); }
    public void visit(AssignExpr AssignExpr) { visit(); }
    public void visit(NoStmt NoStmt) { visit(); }
    public void visit(StmtListExpr StmtListExpr) { visit(); }
    ...
    public void visit(LabeledStmt LabeledStmt) { visit(); }
    ...
    public void visit(FormalParam FormalParam) { visit(); }
    ...
    public void visit(NumberVal NumberVal) { visit(); }
    public void visit(BooleanVal BooleanVal) { visit(); }
    public void visit(ConstDeclSingle ConstDeclSingle) { visit(); }
    public void visit(ConstDeclarationSingle ConstDeclarationSingle) { visit(); }
    public void visit(ConstDeclarationList ConstDeclarationList) { visit(); }
    public void visit(ConstDecl ConstDecl) { visit(); }
    public void visit(NotArray NotArray) { visit(); }
    ...
    public void visit(RecordDeclDerived1 RecordDeclDerived1) { visit(); }
